...
# ╔═╡ e781864d-29cd-44bb-9647-70f890e8bf03
begin
	using ForwardDiff
...
# ╔═╡ 04a80bad-cd67-4bd4-95d6-a27f59a97c72


# ╔═╡ 5c58610c-6a1c-4d90-a9e1-22cdb575a010
rosenbrock(x) = (1 - x[1])^2 + 100 * (x[2] - x[1]^2)^2

# ╔═╡ d0390f2e-e5f7-4d1c-8ee3-c79d8cd6243c
ndros(x) = - ForwardDiff.gradient(rosenbrock, x)

# ╔═╡ 97eac498-99e0-41eb-ba7f-dd0ff095097f
f(u, p, t) = ndros(u)

# ╔═╡ b7360a06-ac54-4250-bf1e-ca2511c8dc56
begin
	u0 = [2.0, 2.0]
	tspan = (0.0, 20.0)
...
# ╔═╡ e29aaf90-05f8-49e2-8905-b3840e344c70
animate(sol, vars=(1,2))
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "c1a59057dfe59297e7b7d14659992fc5b22e4b65"
