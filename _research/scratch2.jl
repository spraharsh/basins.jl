...
@time solve(prob_ode_brusselator_2d_sparse,QNDF(linsolve=KLUFactorization(reuse_symbolic=false), autodiff=false),save_everystep=false) # 342.
@time solve(prob_ode_brusselator_2d_sparse,QNDF(linsolve=KLUFactorization(reuse_symbolic=false), autodiff=false),save_everystep=false) # 342.
@time solve(prob_ode_brusselator_2d_sparse,QNDF(linsolve=KLUFactorization(), autodiff=false),save_everystep=false) # in 0.1
